...
final Color darkBlue = Color.fromARGB(255, 229, 105, 105);
...
//filepici
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 205, 245, 255),
      appBar: AppBar(
        ...
        children: [
          SfCartesianChart(
              ...
              series: <ChartSeries<_SalesData, double>>[
                ...
                SplineSeries<_SalesData, double>(
                    dataSource: data,
                    xValueMapper: (_SalesData sales, _) => sales.fg,
                    yValueMapper: (_SalesData sales, _) => sales.sales,
                    name: 'FG',
                    // Enable data label
                    dataLabelSettings: DataLabelSettings(isVisible: true)),
...
class _SalesData {
  _SalesData(this.year, this.sales, this.fg);
